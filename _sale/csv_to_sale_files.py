...
with codecs.open('inventory.csv', 'r',  "utf-8") as csvfile:
    ...
    for data_row in csv_reader:
            ...
            if item_do == "Sell" and item_status != "Sold":
                ...
                project_file.write('\n##### Beachten:\n')
                project_file.write('**Ich muss es bis zum 27. Oktober verkaufen! Gerne Preisvorschläge schicken!**<br>\n')
                project_file.write('Nur 2 Jahre alt und in gute Zustand.<br>\n')
